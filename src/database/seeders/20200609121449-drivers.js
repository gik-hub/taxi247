  ...
  return queryInterface.bulkInsert(
    ...
    [
      // Within Kigali
      {
        ...
        taxi_reg_no: 'RAE 543 Z',
        current_location: Sequelize.fn(
          'ST_GeomFromText',
          'POINT(30.0810 1.9393)'
        ),
        current_location_name: 'Kacyiru',
      ...
      },
      {
        ...
        current_location_name: 'Nyamirambo',
        availability_status_id: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        current_location_name: 'Nyarutarama',
      ...
      },
      {
        ...
        current_location_name: 'Kimironko',
        availability_status_id: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
